...
class Road(object):
    ...
    def __str__(self):
        ...
        out = "Road: Dump *******************************" + "\n"
        out += "Road: Number in going in Queue == " + str(
            len(self.q_going_in)) + "\n"
        out += "Road: Number in going out Queue == " + str(
            len(self.q_going_out)) + "\n"
        out += "******************************************"
        return out
    ...
    def leave_garage(self, vehicle, curr_t):
        """A method which is called when the vehicle is done parking and is
        trying to enter the road in order to leave"""
